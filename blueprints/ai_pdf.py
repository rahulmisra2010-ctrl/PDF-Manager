...
def detect_fields(doc_id: int):
    """Auto-detect text fields on a single PDF page and return JSON."""
    doc = Document.query.get_or_404(doc_id)
    ...
    try:
        fields = svc.extract_page_fields(doc.file_path, page_num, zoom=zoom)
        return jsonify({"fields": fields, "page": page_num})
